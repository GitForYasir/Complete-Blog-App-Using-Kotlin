...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.saveArticalBtn.setOnClickListener {
        ...
        // to go profile activity by clicking on cardview
        binding.cardView.setOnClickListener{
            startActivity(Intent(this, ProfileActivity::class.java))
        }

        auth = FirebaseAuth.getInstance()
        databaseReference = FirebaseDatabase.getInstance("https://blog-app-6337a-default-rtdb.asia-southeast1.firebasedatabase.app").reference.child("blogs")
        ...
        // set blog post into recyclerview and initialize the recycler view and set adapter
        ...
        databaseReference.addValueEventListener(object :ValueEventListener{
            ...
            override fun onCancelled(error: DatabaseError) {
                Toast.makeText(this@MainActivity, "Blog loading faild!", Toast.LENGTH_SHORT).show()
            }
        })
    ...
    private fun loadUserProfileImage(userId: String) {
        val userReference = FirebaseDatabase.getInstance("https://blog-app-6337a-default-rtdb.asia-southeast1.firebasedatabase.app").reference.child("users").child(userId)
